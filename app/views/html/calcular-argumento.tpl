...
<body>
    ...
    <form action="/calcular-argumento" method="POST"></form>
        <div class="container">
            <div class="section">
                <h2>Parte 1 | Estrangeira</h2>
                <label>Acertos tipo A</label>
                <input type="number" name="acertos_ta_estg">
                <label>Erros tipo A</label>
                <input type="number" name="erros_ta_estg">
                <label>Acertos tipo <B></B></label>
                <input type="number" name="acertos_tb_estg">
                <label>Erros tipo B</label>
                <input type="number" name="erros_tb_estg">
                <label>Acertos tipo C</label>
                <input type="number" name="acertos_tc_estg">
                <label>Erros tipo C</label>
                <input type="number" name="erros_tc_estg">
                <label>Acertos tipo D</label>
                <input type="number" name="acertos_td_estg">
            ...
            <div class="section">
                ...
                <label>Acertos tipo A</label>
                <input type="number" name="acertos_ta_parte_2">
                <label>Erros tipo A</label>
                <input type="number" name="erros_ta_parte_2">
                <label>Acertos tipo B</B></label>
                <input type="number" name="acertos_tb_parte_2">
                <label>Erros tipo B</label>
                <input type="number" name="erros_tb_parte_2">
                <label>Acertos tipo C</label>
                <input type="number" name="acertos_tc_parte_2">
                <label>Erros tipo C</label>
                <input type="number" name="erros_tc_parte_2">
                <label>Acertos tipo D</label>
                <input type="number" name="acertos_td_parte_2">
                <label>Nota da Redação</label>
                <input type="number" name="notaRedacao">
            </div>
        
            <div class="section">
                <h2>Parte 3 | Exatas</h2>
                <label>Acertos tipo A</label>
                <input type="number" name="acertos_ta_parte_3">
                <label>Erros tipo A</label>
                <input type="number" name="erros_ta_parte_3">
                <label>Acertos tipo <B></B></label>
                <input type="number" name="acertos_tb_parte_3">
                <label>Erros tipo B</label>
                <input type="number" name="erros_tb_parte_3">
                <label>Acertos tipo C</label>
                <input type="number" name="acertos_tc_parte_3">
                <label>Erros tipo C</label>
                <input type="number" name="erros_tc_parte_3">
                <label>Acertos tipo D</label>
                <input type="number" name="acertos_td_parte_3">
            </div>
        </div>
