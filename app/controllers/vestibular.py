...
#     def calcular_argumento(self, lingua):
        
#         pontuacao_estg = self.vestibular.calcEstg(
#             self.acertos_ta_estg,
#             self.erros_ta_estg,
#             self.acertos_tb_estg,
#             self.acertos_tc_estg,
#             self.erros_tc_estg,
#             self.acertos_td_estg
#         )
#         pontuacao_parte_2 = self.vestibular.calcP2(
#             self.acertos_ta_parte_2,
#             self.erros_ta_parte_2,
#             self.acertos_tb_parte_2,
#             self.acertos_tc_parte_2,
#             self.erros_tc_parte_2,
#             self.acertos_td_parte_2
#         )
#         pontuacao_parte_3 = self.vestibular.calcP3(
#             self.acertos_ta_parte_3,
#             self.erros_ta_parte_3,
#             self.acertos_tb_parte_3,
#             self.acertos_tc_parte_3,
#             self.erros_tc_parte_3,
#             self.acertos_td_parte_3
#         )

#         arg_estg = self.vestibular.argEstg(pontuacao_estg, lingua)
#         arg_parte_2 = self.vestibular.argP2(pontuacao_parte_2)
#         arg_parte_3 = self.vestibular.argP3(pontuacao_parte_3)
#         arg_redacao = self.vestibular.argRed(self.notaRedacao)

#         argumento_final_gp_1, argumento_final_gp_2 = self.vestibular.argFinal(
#             arg_estg, arg_parte_2, arg_parte_3, arg_redacao
#         )
